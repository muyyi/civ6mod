...
FROM Improvement_ValidBuildUnits WHERE UnitType = 'UNIT_BUILDER' AND Buildable = 1;
...
VALUES	('TRAIT_DOLL_WONDER_PERCENT', 'Amount', 5),
		...
		('TRAIT_SHANGHAI_SIEGE_BONUS_MODIFIER', 'Amount', 50) ,
...
-- VALUES	('PROMOTION_SHANGHAI_L1L', 'GUNBOATDIPLOMACY_OPENBORDERS') ,
-- 		('PROMOTION_SHANGHAI_L1L', 'GUNBOATDIPLOMACY_INFLUENCEPOINTS') ,
-- 		('PROMOTION_SHANGHAI_L2L', 'UNIQUE_LEADER_ADD_VISIBILITY') ,
-- 		('PROMOTION_SHANGHAI_L2L', 'MARISA_ADD_TRADE_ROUTE_CAPACITY') ,
-- 		('PROMOTION_SHANGHAI_L2L', 'MARISA_GRANT_TRADER') ,
-- 		('PROMOTION_SHANGHAI_L3L', 'POTALA_PALACE_DIPLOMATIC_GOVERNMENT_SLOT') ,
-- 		('PROMOTION_SHANGHAI_L1R', 'TRAIT_BARBARIAN_CAMP_GOODY') ,
-- 		('PROMOTION_SHANGHAI_L2R', 'UNIQUE_LEADER_SPIES_START_PROMOTED') ,
-- 		('PROMOTION_SHANGHAI_L3R', 'UNIQUE_LEADER_ADD_SPY_CAPACITY') ,
-- 		('PROMOTION_SHANGHAI_L3R', 'UNIQUE_LEADER_ADD_SPY_UNIT') ,
-- 		('PROMOTION_SHANGHAI_L4', 'ALLIANCE_ADJUST_PLAYER_TRADE_ROUTE_CAPACITY') ,
-- 		('PROMOTION_SHANGHAI_L4', 'MARISA_FOOD_TO_INCOMING_FOREIGN_ROUTES') ,
-- 		('PROMOTION_SHANGHAI_L4', 'MARISA_FOOD_FROM_INCOMING_FOREIGN_ROUTES') ,
...
VALUES	('SPY_CHOOSE_SKILL', 'MODIFIER_PLAYER_UNIT_GRANT_UNLIMITED_PROMOTION_CHOICES', NULL) ,
		...
		('MARISA_CULTURE_FROM_INCOMING_FOREIGN_ROUTES', 'MODIFIER_PLAYER_CITIES_ADJUST_TRADE_ROUTE_YIELD_FROM_OTHERS', 'PLAYER_IS_AT_PEACE_WITH_ALL_MAJORS'),
		...
		('MARISA_EXTRA_FOOD_TO_ALLY', 'MODIFIER_PLAYER_ADJUST_TRADE_ROUTE_DESTINATION_YIELD_FOR_ALLY_ROUTE', 'PLAYER_IS_AT_PEACE_WITH_ALL_MAJORS') ,
		('MARISA_EXTRA_FOOD_FROM_ALLY', 'MODIFIER_PLAYER_ADJUST_TRADE_ROUTE_DESTINATION_YIELD_FOR_ALLY_ROUTE', 'PLAYER_IS_AT_PEACE_WITH_ALL_MAJORS'),
		('MARISA_EXTRA_PRODUCTION_TO_ALLY', 'MODIFIER_PLAYER_ADJUST_TRADE_ROUTE_DESTINATION_YIELD_FOR_ALLY_ROUTE', 'PLAYER_IS_AT_PEACE_WITH_ALL_MAJORS') ,
		('MARISA_EXTRA_PRODUCTION_FROM_ALLY', 'MODIFIER_PLAYER_ADJUST_TRADE_ROUTE_DESTINATION_YIELD_FOR_ALLY_ROUTE', 'PLAYER_IS_AT_PEACE_WITH_ALL_MAJORS'),
		('MARISA_EXTRA_CULTURE_TO_ALLY', 'MODIFIER_PLAYER_ADJUST_TRADE_ROUTE_DESTINATION_YIELD_FOR_ALLY_ROUTE', 'PLAYER_IS_AT_PEACE_WITH_ALL_MAJORS') ,
		('MARISA_EXTRA_CULTURE_FROM_ALLY', 'MODIFIER_PLAYER_ADJUST_TRADE_ROUTE_DESTINATION_YIELD_FOR_ALLY_ROUTE', 'PLAYER_IS_AT_PEACE_WITH_ALL_MAJORS'),
		('MARISA_EXTRA_GOLD_TO_ALLY', 'MODIFIER_PLAYER_ADJUST_TRADE_ROUTE_DESTINATION_YIELD_FOR_ALLY_ROUTE', 'PLAYER_IS_AT_PEACE_WITH_ALL_MAJORS') ,
		('MARISA_EXTRA_GOLD_FROM_ALLY', 'MODIFIER_PLAYER_ADJUST_TRADE_ROUTE_DESTINATION_YIELD_FOR_ALLY_ROUTE', 'PLAYER_IS_AT_PEACE_WITH_ALL_MAJORS'),
		...
		('SHINKI_RELIGIOUS_BELIEF_FAITH', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', 'PLAYER_FOUNDED_RELIGION_REQUIREMENTS'),
		('SHINKI_RELIGIOUS_BELIEF_GOLD', 'MODIFIER_PLAYER_CITIES_ATTACH_MODIFIER', NULL),
		('SHINKI_RELIGIOUS_BELIEF_FAITH_MODIFIER', 'MODIFIER_PLAYER_RELIGION_ADD_RELIGIOUS_BELIEF_YIELD', 'PLAYER_FOUNDED_RELIGION_REQUIREMENTS'),
...
VALUES	('SPY_CHOOSE_SKILL', 'UnitType', 'UNIT_SPY'),
		...
		('MARISA_ADD_TRADE_ROUTE_CAPACITY', 'Amount', 2) ,
		('MARISA_GRANT_TRADER', 'UnitType', 'UNIT_TRADER') ,
		('MARISA_GRANT_TRADER', 'Amount', 2),
		...
		('MARISA_EXTRA_CULTURE_TO_ALLY', 'Amount', 1),
		('MARISA_EXTRA_CULTURE_FROM_ALLY', 'YieldType', 'YIELD_CULTURE') ,
		('MARISA_EXTRA_CULTURE_FROM_ALLY', 'Amount', 1),
		...
		('SHINKI_RELIGIOUS_BELIEF_FAITH', 'ModifierId', 'SHINKI_RELIGIOUS_BELIEF_FAITH_MODIFIER') ,
		('SHINKI_RELIGIOUS_BELIEF_GOLD', 'ModifierId', 'SHINKI_RELIGIOUS_BELIEF_GOLD_MODIFIER') ,
...
VALUES	('TRAIT_SHANGHAI_VS_MELEE_BONUS_MODIFIER', 'Preview', 'LOC_SHANGHAI_VS_MELEE_BONUS') ,
	...
	('MARISA_FOOD_TO_INCOMING_FOREIGN_ROUTES', 'Preview', 'LOC_MARISA_FOOD_TO_INCOMING_FOREIGN_ROUTES_BONUS') ,
	('MARISA_PRODUCTION_TO_INCOMING_FOREIGN_ROUTES', 'Preview', 'LOC_MARISA_PRODUCTION_TO_INCOMING_FOREIGN_ROUTES_BONUS') ,
	('MARISA_CULTURE_TO_INCOMING_FOREIGN_ROUTES', 'Preview', 'LOC_MARISA_CULTURE_TO_INCOMING_FOREIGN_ROUTES_BONUS') ,
	('MARISA_GOLD_TO_INCOMING_FOREIGN_ROUTES', 'Preview', 'LOC_GOLD_TO_INCOMING_FOREIGN_BONUS') ;
