...
VALUES	('TRAIT_DOLL_WONDER_PERCENT', 'MODIFIER_PLAYER_ADJUST_UNIT_WONDER_PERCENT', NULL) ,
		...
		('TRAIT_SHANGHAI_CORPS_STRENGTH', 'MODIFIER_PLAYER_CORPS_ARMY_MODIFIED_STRENGTH', 'REQ_UNIT_IS_SHANGHAI') ,
		('TRAIT_SHANGHAI_ARMIES_STRENGTH', 'MODIFIER_PLAYER_CORPS_ARMY_MODIFIED_STRENGTH', 'REQSET_UNIT_IS_PENGLAI') ,
		('TRAIT_SHANGHAI_MOVE_FAST', 'MODIFIER_PLAYER_UNITS_GRANT_PROMOTION', 'REQ_UNIT_IS_SHANGHAI') ,
		('TRAIT_PENGLAI_CORPS_STRENGTH', 'MODIFIER_PLAYER_CORPS_ARMY_MODIFIED_STRENGTH', 'REQ_UNIT_IS_SHANGHAI') ,
