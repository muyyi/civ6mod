...
VALUES	('REQSET_UNIT_ADJ_DOLL', 'REQUIREMENTSET_TEST_ANY') ;

INSERT INTO Requirements 
		(RequirementId, RequirementType)
VALUES	('REQ_UNIT_ADJ_SHANGHAI', 'REQUIREMENT_PLOT_ADJACENT_FRIENDLY_UNIT_TYPE_MATCHES'), 
		('REQ_UNIT_ADJ_PENGLAI', 'REQUIREMENT_PLOT_ADJACENT_FRIENDLY_UNIT_TYPE_MATCHES') ;


INSERT INTO RequirementSetRequirements
		(RequirementSetId, RequirementId)
VALUES	('REQSET_UNIT_ADJ_DOLL', 'REQ_UNIT_ADJ_SHANGHAI'),
 		('REQSET_UNIT_ADJ_DOLL', 'REQ_UNIT_ADJ_PENGLAI');

INSERT INTO RequirementArguments
		(RequirementId, Name, Value)
VALUES	('REQ_UNIT_ADJ_SHANGHAI', 'UnitType', 'UNIT_SHANGHAI'),
		('REQ_UNIT_ADJ_PENGLAI', 'UnitType', 'UNIT_PENGLAI') ;
...
SELECT 'ALICE_PLAYER_CAN_BUILD_' || ImprovementType, 'MODIFIER_CITY_ADJUST_ALLOWED_IMPROVEMENT', 0, 0, NULL, NULL
FROM Improvements;
...
VALUES	('TRAIT_DOLL_WONDER_PERCENT', 'MODIFIER_PLAYER_ADJUST_UNIT_WONDER_PERCENT', NULL) ,
		...
		('TRAIT_SHANGHAI_MOVE_FAST', 'MODIFIER_PLAYER_UNITS_GRANT_PROMOTION', NULL) ,
		...
		('TRAIT_PENLAI_STEALTH', 'MODIFIER_PLAYER_UNITS_GRANT_PROMOTION', NULL) ,
