...
VALUES	('PROMOTION_MARISA_DIPLOMAT_MASTERSPARK_1', 'GUNBOATDIPLOMACY_OPENBORDERS') ,
		...
		('PROMOTION_MARISA_DIPLOMAT_LADY_KILLER_3', 'ARSENALOFDEMOCRACY_ALLIANCEPOINTS') ,

		('PROMOTION_MARISA_BATTLE_MASTER_ADD_COMBOT_1', 'MARISA_MASTER_SPARK_1') ,
		('PROMOTION_MARISA_BATTLE_MASTER_ADD_COMBOT_2', 'MARISA_MASTER_SPARK_2') ,
		('PROMOTION_MARISA_BATTLE_MASTER_ADD_COMBOT_3', 'MARISA_MASTER_SPARK_3') ,
		-- 气球的效果，不仅加自己，还加周围右方单位，可能要改
		('PROMOTION_MARISA_BATTLE_MASTER_ADD_COMBOT_3', 'OBSERVATION_INCREASED_SIGHT_RANGE') ,
